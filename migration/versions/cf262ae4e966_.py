...
Revision ID: cf262ae4e966
Revises: bad2cd8c7753
Create Date: 2025-05-12 14:56:38.217240
...
revision: str = 'cf262ae4e966'
down_revision: Union[str, None] = 'bad2cd8c7753'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.dialects.postgresql.UUID(as_uuid=True), primary_key=True, nullable=False, default=sa.text('gen_random_uuid()')),
